...
class TestWiggleSubsequence extends FunSuite {
    test("case01") {
        val input = Array(1, 7, 4, 9, 2, 5)
        val expected = 6
        assert(WiggleSubsequence.wiggleMaxLength(input) === expected)
    }
